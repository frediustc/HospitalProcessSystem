              ...
              <div class="card">
                ...
                <div class="card-block">
                  <table class="table table-striped table-sm">
                      <?php
                      $cons = $db->prepare('SELECT * FROM consultation ORDER BY status DESC');
                    ...
                    <tbody>
                        <?php while ($con = $cons->fetch()) {
                            ...
                            $nur = $db->prepare('SELECT fullname FROM users WHERE id = ?');
                            $nur->execute(array($con['nurseid']));
                            $n = $nur->fetch();
                            ?>
                            <tr>
