              ...
              <div class="card">
                ...
                <div class="card-block">
                  <table class="table table-striped table-sm">
                      <?php
                      $cons = $db->prepare('SELECT * FROM consultation WHERE assignto = ? AND status = "queue" ORDER BY status DESC');
                    ...
                    <tbody>
                        <?php while ($con = $cons->fetch()) {
                            ...
                            <tr>
                              ...
                              <td>
                                  <a href="consult.php?id=<?php echo $con['id']; ?>" class="btn btn-primary" title="start consultation"><span class="fa fa-user-md"></span></a>
                              </td>
                            </tr>
                        <?php } ?>
